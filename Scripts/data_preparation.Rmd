...
primates_tree <- read.newick("Data/233-GENOMES/science.abn7829_data_s4.nex.tree")
...
```{r to be removed, fig.height=40, fig.width=80}
...
# sorted_tree <- SortTree(tree, how = "TipLabels", order = TipLabels(tree))
# 
# comparePhylo(sorted_tree, nw_tree, plot = TRUE, force.rooted = TRUE)
...
```{r heatmap, fig.height=18, fig.width=18, dev=}

...
\FunctionTok{write.tree}\NormalTok{(tree, }\AttributeTok{file=}\StringTok{"Out/1.Pruning/tree\_pruning/science.abn7829\_data\_s4.nex.tree.pruned"}\NormalTok{)}
...
\NormalTok{ordered\_columns }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"SPECIES\_BINOMIAL"}\NormalTok{, }\FunctionTok{rev}\NormalTok{(}\FunctionTok{colnames}\NormalTok{(clusters\_df)[}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]))}
...
\CommentTok{\# Recover the cluster file por posterior use}
\FunctionTok{write.csv}\NormalTok{(clusters\_unique, }\AttributeTok{file=}\StringTok{"Out/2.Clustering/traits\_clusters\_exploration/clusters\_unique.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Recover the cluster file por posterior use}
\FunctionTok{write.csv}\NormalTok{(clusters\_unique\_expanded, }\AttributeTok{file=}\StringTok{"Out/2.Clustering/traits\_clusters\_exploration/clusters\_unique\_expanded.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\hypertarget{visualizing-cluster-distribution-with-species-present-in-the-phylogeny-and-trait-values}{%
\subsubsection{Visualizing cluster distribution with species present in
the phylogeny and trait
values}\label{visualizing-cluster-distribution-with-species-present-in-the-phylogeny-and-trait-values}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Extracting tip labels order from the phylo object}
\NormalTok{ordered\_species }\OtherTok{\textless{}{-}} \FunctionTok{rev}\NormalTok{(tree}\SpecialCharTok{$}\NormalTok{tip.label)}
...
\CommentTok{\# Reorder the levels of the cut factor to place FAMILY first}
\NormalTok{ordered\_cuts }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"FAMILY"}\NormalTok{, }\FunctionTok{sort}\NormalTok{(}\FunctionTok{unique}\NormalTok{(clusters\_long}\SpecialCharTok{$}\NormalTok{cut[clusters\_long}\SpecialCharTok{$}\NormalTok{cut }\SpecialCharTok{!=} \StringTok{"FAMILY"}\NormalTok{])))}
\NormalTok{clusters\_long}\SpecialCharTok{$}\NormalTok{cut }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(clusters\_long}\SpecialCharTok{$}\NormalTok{cut, }\AttributeTok{levels =}\NormalTok{ ordered\_cuts)}
...
\NormalTok{all\_colors }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(family\_colors, cluster\_colors)}
\NormalTok{all\_levels }\OtherTok{\textless{}{-}} \FunctionTok{unique}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\FunctionTok{as.character}\NormalTok{(clusters\_unique}\SpecialCharTok{$}\NormalTok{FAMILY), }\FunctionTok{as.character}\NormalTok{(clusters\_long}\SpecialCharTok{$}\NormalTok{cluster)))}
...
\includesvg{data_preparation_files/figure-latex/unnamed-chunk-10-1.svg}
...
\CommentTok{\# Reorder the levels of the cut factor to place FAMILY first}
\NormalTok{ordered\_cuts }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"FAMILY"}\NormalTok{, }\FunctionTok{sort}\NormalTok{(}\FunctionTok{unique}\NormalTok{(clusters\_expanded\_long}\SpecialCharTok{$}\NormalTok{cut[clusters\_expanded\_long}\SpecialCharTok{$}\NormalTok{cut }\SpecialCharTok{!=} \StringTok{"FAMILY"}\NormalTok{])))}
\NormalTok{clusters\_expanded\_long}\SpecialCharTok{$}\NormalTok{cut }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(clusters\_expanded\_long}\SpecialCharTok{$}\NormalTok{cut, }\AttributeTok{levels =}\NormalTok{ ordered\_cuts)}
...
\includesvg{data_preparation_files/figure-latex/unnamed-chunk-11-1.svg}
...
\includesvg{data_preparation_files/figure-latex/unnamed-chunk-12-1.svg}
